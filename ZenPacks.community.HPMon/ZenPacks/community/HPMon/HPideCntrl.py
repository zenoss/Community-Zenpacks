...
HPideCntrl is an abstraction of a HP IDE Controller.

$Id: HPideCntrl.py,v 1.0 2008/12/09 14:31:24 egor Exp $"""
...
class HPideCntrl(ExpansionCard):
    """IDE Cntrl object"""
    ...
    factory_type_information = ( 
        { 
            ...
            'immediate_view' : 'viewHPideCntrl',
            'actions'        :
            ( 
                { 'id'            : 'status'
                , 'name'          : 'Status'
                , 'action'        : 'viewHPideCntrl'
                , 'permissions'   : ('View',)
                },
                { 'id'            : 'perfConf'
                , 'name'          : 'Template'
