...
__doc__="""HPsasHardDisk

HPsasHardDisk is an abstraction of a harddisk.

$Id: HPsasHardDisk.py,v 1.0 2009/03/10 12:46:24 egor Exp $"""
...
class HPsasHardDisk(HPHardDisk):
    """HPsasHardDisk object
    ...
    portal_type = meta_type = 'HPsasHardDisk'
