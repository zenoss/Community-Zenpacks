...
__doc__="""HPscsiHardDisk

HPscsiHardDisk is an abstraction of a harddisk.

$Id: HPscsiHardDisk.py,v 1.0 2009/03/10 12:46:24 egor Exp $"""
...
class HPscsiHardDisk(HPHardDisk):
    """HPscsiHardDisk object
    ...
    portal_type = meta_type = 'HPscsiHardDisk'
...
InitializeClass(HPscsiHardDisk)
