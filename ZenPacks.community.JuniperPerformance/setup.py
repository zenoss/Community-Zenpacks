...
NAME = "ZenPacks.community.JuniperPerformance"
VERSION = "1.0"
AUTHOR = "Randy Schneiderman"
LICENSE = "GPLv2"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.community']
PACKAGES = ['ZenPacks', 'ZenPacks.community', 'ZenPacks.community.JuniperPerformance']
INSTALL_REQUIRES = []
COMPAT_ZENOSS_VERS = '>=2.2'
PREV_ZENPACK_NAME = "JuniperPerformance"
# STOP_REPLACEMENTS
################################
