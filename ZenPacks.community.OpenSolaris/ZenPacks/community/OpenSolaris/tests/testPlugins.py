...
from ZenPacks.community.OpenSolaris.modeler.plugins.zenoss.cmd.solaris.ifconfig \
        import ifconfig
from ZenPacks.community.OpenSolaris.modeler.plugins.zenoss.cmd.solaris.df_ag \
        import df_ag
...
class OpenSolarisPluginsTestCase(BasePluginsTestCase):
    ...
    def runTest(self):
        ...
        directory.
        """
        Plugins = [ df_ag,ifconfig,netstat_r_vn,netstat_an,cpu,memory,opensolaris_uname_a,pkginfo, process]
