...
log = logging.getLogger("zen.zensunprocess")
...
HOSTROOT  ='.1.3.6.1.4.1.42.3.12.1.1'
NAMETABLE = HOSTROOT + '.10'
CPU       = HOSTROOT + '.3.'        # note trailing dot
MEM       = HOSTROOT + '.4.'        # note trailing dot
...
if __name__ == '__main__':
    ...
    from ZenPacks.community.SunMibMonitor.zensunprocess import zensunprocess
    z = zensunprocess()
    z.run()
