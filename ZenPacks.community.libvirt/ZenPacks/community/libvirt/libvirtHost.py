...
class libvirtHost(Device):
	...
	('libvirtpools', ToManyCont(ToOne, "ZenPacks.community.libvirt.libvirtPool", "libvirthost")),
	('libvirtvolumes', ToManyCont(ToOne, "ZenPacks.community.libvirt.libvirtVolume", "libvirthost")),
    )
